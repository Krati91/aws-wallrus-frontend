        ...
        <Grid container className={classes.Grid} spacing={6}>
          {underReviews.length <= 0 ? (
            ...
            underReviews.map((review) => {
              ...
              if (review.colorway_set.length > 0 && review.colorway_set[0].color_tags.length > 0) {
              ...
              return (<Grid item xs={12} md={6} lg={4} xl={4}>
              <div className="under-review-card">
                <img
                  className="under-review-image"
                  src={review.colorway_set.length > 0 ? review.colorway_set[0].image_url : design}
                  alt="img"
                />
